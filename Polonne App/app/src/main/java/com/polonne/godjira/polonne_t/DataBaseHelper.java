...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static final String POINTS_NAME = "name";
     //-------------- TABLE MAP POINTS----------------
    private static final String TABLE_MAP_POINTS = "mapPoints";
    private static final String MAP_POINTS_ID = "id";
    private static final String MAP_POINTS_TITLE = "title";
    private static final String MAP_POINTS_LATITUDE = "latitude";
    private static final String MAP_POINTS_LONGITUDE = "longitude";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_POINTS_TABLE = "CREATE TABLE " + TABLE_POINTS + "("
                ...
                + POINTS_NAME + " TEXT" + ")";
        String CREATE_MAP_POINTS_TABLE = "CREATE TABLE " + TABLE_MAP_POINTS + "("
                + MAP_POINTS_ID + " INTEGER," + MAP_POINTS_TITLE + " TEXT,"
                + MAP_POINTS_LATITUDE + " REAL" + MAP_POINTS_LONGITUDE + " REAL" + ")";
        ...
        db.execSQL(CREATE_MAP_POINTS_TABLE);
    }
